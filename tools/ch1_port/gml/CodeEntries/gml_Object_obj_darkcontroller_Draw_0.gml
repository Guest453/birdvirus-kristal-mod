...
if (global.menuno == 5)
{
    ...
    if (global.submenu == 35)
    {
        ...
        draw_set_color(c_white);
        draw_text(xx + 105, yy + 100 + _headerOffset, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_113_0")));
        if (global.is_console)
        {
        ...
        {
            draw_text(xx + 325, yy + 100 + _headerOffset, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_114_0")));
            if (obj_gamecontroller.gamepad_active)
            {
                draw_text(xx + 435, yy + 100 + _headerOffset, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_115_0")));
            }
        }
        function_n[0] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_117_0");
        function_n[1] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_118_0");
        function_n[2] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_119_0");
        function_n[3] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_120_0");
        function_n[4] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_121_0");
        function_n[5] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_122_0");
        function_n[6] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_123_0");
        function_n[7] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_124_0");
        function_n[8] = scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_125_0");
