...
{
    global.monster[i] = 1;
    global.monstername[i] = scr_84_get_lang_string("obj_initializer_slash_Create_0_gml_114_0");
...
for (i = 0; i < 10; i += 1)
{
    ...
    global.smstring[i] = scr_84_get_lang_string("obj_initializer_slash_Create_0_gml_158_0");
}
global.smalarm[1] = 15;
global.smyy[1] = 70;
global.smxx[1] = 700;
